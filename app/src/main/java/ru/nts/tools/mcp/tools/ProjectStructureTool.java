...
public class ProjectStructureTool implements McpTool {
    ...
    public JsonNode execute(JsonNode params) throws Exception {
        ...
        TreeVisitor visitor = new TreeVisitor(rootPath, maxDepth, ignorePatterns, sb);
    ...
    private static class TreeVisitor extends SimpleFileVisitor<Path> {
        ...
        public TreeVisitor(Path root, int maxDepth, List<String> ignorePatterns, StringBuilder sb) {
            this.root = root;
