...
public class GitCommitSessionTool implements McpTool {
    ...
    @Override
    public String getName() { return "nts_git_commit_session"; }    @Override
    public String getDescription() {
        return "Auto-commit current changes with message generated from session instructions and TODO status.";
    }
